...
class _CartScreenState extends State<CartScreen> {
  ...
  calculateTotal(index) {
    ...
    setState(() {
      Session.data.setInt('totalPriceCart', totalPriceCart);
    });
  }
  ...
  increaseQuantity(index) {
    setState(() {
      productCart[index].priceTotal = (productCart[index].cartQuantity *
          int.parse(productCart[index].productPrice));
    });
    if (productCart[index].isSelected) {
      reCalculateTotalOrder();
    }
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              height: 80.h,
              width: 80.w,
              child: Image.network(productCart[index].images[0].src),
            ),
            Expanded(
              flex: 7,
              child: Container(
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      child: ListView.builder(
                          shrinkWrap: true,
                          itemCount: productCart[index].attributes.length,
                          itemBuilder: (context, j) {
                            return Text(
                                '${productCart[index].attributes[j].name} : ${productCart[index].attributes[j].selectedVariant}',
                                style: TextStyle(
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                "${productCart[index].discProduct.toInt()}%",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: responsiveFont(9)),
                              ),
                            ...
                            Text(
                              stringToCurrency(
                                  double.parse(productCart[index].productRegPrice),
                                  context),
                              style: TextStyle(
                  ...
                  Row(
                    children: [
                        ...
                        children: [
                          ...
                          coupons.couponUsed == null
                              ...
                              : Visibility(
                                  ...
                                  child: Text(
                                    "${AppLocalizations.of(context)
                                        .translate('discount')} : ${stringToCurrency(double.parse(coupons.couponUsed.amount), context)}",
                                    style:
                      ...
                      TextButton(
                        ...
                        child: Text(
                          "${AppLocalizations.of(context)
                              .translate('checkout')}($totalSelected)",
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text(
                        '${AppLocalizations.of(context)
                            .translate('delete')} $totalSelected item?',
