                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                          stringToCurrency(
                              double.parse(couponModel.amount),
                              context),
                          style: TextStyle(
                              color: Colors.white,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            padding: EdgeInsets.symmetric(horizontal: 15),
                            child: Text(
                              "${convertDateFormatFull(DateTime.parse(couponModel.dateCreated))} - ${convertDateFormatFull(DateTime.parse(couponModel.dateExpires))}",
                              style: TextStyle(
                                fontSize: responsiveFont(10),
                              ),
                            ),
