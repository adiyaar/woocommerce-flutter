          ...
          return Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  value.productRecommendation.description,
                  style: TextStyle(
                    fontSize: 14,
                  ),
                ),
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Image.network(general.logo.image),
                                  Container(
                                    width: 12,
                                  ),
                                  Visibility(
